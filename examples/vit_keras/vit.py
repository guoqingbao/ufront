...
def build_model(
    ...
    shape=(image_size_tuple[0], image_size_tuple[1], 3)
    if channel_first:
        shape=(3, image_size_tuple[0], image_size_tuple[1])
    ...
    y = tf.keras.layers.Reshape((y.shape[2] * y.shape[3] if channel_first else y.shape[1] * y.shape[2], hidden_size))(y)
