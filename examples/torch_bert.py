...
#***************************************************
#Slightly revised from Google 'pytorch_pretrained_bert' model for UFront
#***************************************************
...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None):
        ...
        position_ids = self.arange(seq_length, dtype=torch.long, device=input_ids.device)
...
class BertSelfAttention(nn.Module):
    ...
    def transpose_for_scores(self, x):
        ...
        x = x.view(new_x_shape[0], new_x_shape[1], new_x_shape[2], new_x_shape[3])
